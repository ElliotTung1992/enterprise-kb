...
class TraceArchitectureTest {
    ...
    void ragServicesDoNotDependOnTraceRecorderDtosOrJsonHelpers() throws Exception {
        assertClean("src/main/java/com/enterprise/kb/search/service/impl/QnAServiceImpl.java");
        assertClean("src/main/java/com/enterprise/kb/search/service/impl/AgenticQnAServiceImpl.java");
    ...
    void turnLifecycleIsOwnedByAop() throws Exception {
        String standardRag = Files.readString(Path.of(
                "src/main/java/com/enterprise/kb/search/service/impl/QnAServiceImpl.java"));
        String agenticRag = Files.readString(Path.of(
                "src/main/java/com/enterprise/kb/search/service/impl/AgenticQnAServiceImpl.java"));
        ...
        assertThat(standardRag).contains("@TraceTurn(traceType = \"STANDARD_QA\"");
        assertThat(agenticRag).contains("@TraceTurn(traceType = \"AGENTIC_QA\"");
