...
MINIMAX_API_KEY=your_minimax_key          # 默认 AI 提供商（必填）
...
| 提供商 | 模型 | 特点 | 需要密钥 |
|--------|------|------|----------|
| MiniMax（默认） | abab6.5s-chat | 中英文均衡，性价比高 | MINIMAX_API_KEY |
